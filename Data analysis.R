...
# this is the analysis for Broderick et al. 2024
...
sitexsp <- sitexsp_wmeta[,12:3039]  
coldata <- sitexsp_wmeta[,1:11]# this is  metadata
...
permanova.resource.season <- betadisper(sitesp_resource_bray , group= resource_sitexsp_wmeta$MAP)
permanova.resource.season 
permutest(permanova.resource.season) # nope
